...
describe('Tool Filtering', () => {
  ...
  it('should register all tools when no filter is provided', () => {
    ...
    // 5 mocked endpoints + 1 get-meeting-transcript-markdown utility tool
  ...
  it('should handle invalid regex patterns gracefully', () => {
    ...
    // 5 mocked endpoints + 1 get-meeting-transcript-markdown utility tool (no filter on invalid regex)
    expect(toolSpy).toHaveBeenCalledTimes(6);
  });
