...
const { loadConfig, resolveModelInternal, findPhaseInternal, getRoadmapPhaseInternal, pathExistsInternal, generateSlugInternal, getMilestoneInfo, getMilestonePhaseFilter, stripShippedMilestones, extractCurrentMilestone, normalizePhaseName, toPosixPath, output, error, addAgentStatusToResult, phaseTokenMatches } = require('./core.cjs');
...
function withProjectRoot(cwd, result) {
  ...
  // Workflows use agent_install_mode to choose native subagent dispatch or lazy-agent.
  addAgentStatusToResult(result);
