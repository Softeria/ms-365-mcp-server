...
INSTALL_JS_GLOBAL="${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node ${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
