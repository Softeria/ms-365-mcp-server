...
Parse JSON for: `agent_install_mode`, `researcher_model`, `synthesizer_model`, `roadmapper_model`, `commit_docs`, `project_exists`, `has_codebase_map`, `planning_exists`, `has_existing_code`, `has_package_file`, `is_brownfield`, `needs_codebase_map`, `has_git`, `project_path`, `agents_installed`, `missing_agents`.

**If `agents_installed` is false:** Display a warning before proceeding:
```
⚠ GSD agents not available in native agents/ or agents-lazy/:
  {missing_agents joined with newline}

If lazy agents are present but unavailable, restore the lazy-agent skill at ~/.claude/skills/lazy-agent/SKILL.md.
Otherwise run the installer with --global to restore GSD agent files:
...
Use template: ${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: ${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: ${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: ${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: ${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/research-project/SUMMARY.md
