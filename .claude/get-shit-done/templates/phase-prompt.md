...
<!-- For checkpoint task examples and patterns, see @${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/references/checkpoints.md -->
...
See `${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `${CLAUDE_PROJECT_DIR:-$(git rev-parse --show-toplevel)}/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
